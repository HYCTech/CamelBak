...
export default new Router({
    routes: [{
...

        {
            ...
            menu: true,
            children: [
                { path: '/index/proprietors', name: '业主', component:  _import('pages/peopleMag/nowUserPeople/proprietors'), meta: { index: '1-1-1' } },
                { path: '/index/propertyOfc', name: '物业处人员', component:  _import('pages/peopleMag/nowUserPeople/propertyOfc'), meta: { index: '1-1-2' } }
            ]
        },
        {
            path: '/index',
