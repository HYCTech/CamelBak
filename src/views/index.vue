    ...
    <div class="main">
      <div class="nav">
        ...
        <el-menu unique-opened :default-active="active" class="" theme="dark">
          ...
          <el-menu-item index="6" @click="$router.push('/index/material')"><i class="el-icon-menu"></i>材料管理
          </el-menu-item>
          <el-menu-item index="7" @click="$router.push('/index/notice')"><i class="el-icon-warning"></i>通知
          </el-menu-item>
          <el-menu-item index="8" @click="$router.push('/index/setting')"><i class="el-icon-setting"></i>设置
          </el-menu-item>
      ...
      <div class="content">
        <div class="userInfo">
          ...
          <div class="fr userInfo-c">
            ...
            <el-dropdown>
                        <span class="el-dropdown-link">
                         <img src="../assets/image/a0.jpg"> {{ui.name}}<i
                          class="el-icon-caret-bottom el-icon--right"></i>
                        </span>
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item @click.native="got('/index/userInfo',0)"><i class="el-icon-document"></i>个人资料
                </el-dropdown-item>
