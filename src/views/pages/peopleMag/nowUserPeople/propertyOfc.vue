<template>
  <div>
    ...
    <!-- 分页 -->
    <PageBar :pageData="pageData" :getData="getPropertyOfcInfo" ></PageBar>
    <!-- 弹出框 -->
  ...
  export default {
    ...
    methods: {
      ...
      tableCurrentChange(row) {
       ...
       //获取分页数据
      getPropertyOfcInfo() {
        api.getPropertyOfcInfo(this.pageData.page-1,this.pageData.pageSize).then(res => {
          console.log(res);
